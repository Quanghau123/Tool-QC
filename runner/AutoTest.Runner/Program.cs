...
await using(var validationRegistry=new StepExecutorRegistry(new ITestStepExecutor[]{new HttpStepExecutor(project,env),new PostgreSqlStepExecutor(),new MqttStepExecutor(env),new HttpStubStepExecutor(env)}))
{
